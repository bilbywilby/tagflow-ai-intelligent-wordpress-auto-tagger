        ...
        <main>
          {filteredFeeds.length > 0 ? (
            ...
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="min-h-[400px] flex flex-col items-center justify-center text-center p-12 border-2 border-dashed rounded-4xl bg-muted/10 border-muted-foreground/10"
            >
